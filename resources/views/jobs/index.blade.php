        ...
        <form x-ref="filters" action="{{ route('jobs.index') }}" id="filtering-form" method="GET">
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <x-text-input name="min_salary" value="{{ request('min_salary') }}"
                            placeholder="From" form-ref="filters"></x-text-input>
                        <x-text-input name="max_salary" value="{{ request('max_salary') }}"
                            placeholder="To"  form-ref="filters"></x-text-input>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <x-radio-input name="category" :options="\App\Models\Job::$categories">
                    </x-radio-input>
                </div>
            </div>
