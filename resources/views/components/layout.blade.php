...
<body class="mx-auto mt-11 max-w-2xl bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 text-slate-700">
    ...
    @if(session('success'))
    <div x-data="{ show : true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" role="alert" class="my-8 roundend-md border-l-4 border-green-300 bg-green-100 p-4 text-green-700 opacity-75">
