         ...
         <form action="{{ route('my-jobs.update', $job) }}" method="POST">
             ...
             <div class="mb-4 grid grid-cols-2 gap-4">
                 ...
                 <div>
                     ...
                     <x-radio-input name="experience" :value="$job->experience" :allOption="false" :options="array_combine(
                 ...
                 <div>
                     ...
                     <x-radio-input name="category" :value="$job->category" :allOption="false" :options="array_combine(
                         array_map('ucfirst', \App\Models\Job::$categories),
